 ...
 * リトライも失敗した場合は例外を投げる。
 */
async function sendMessageBatch(queueUrl, messageBodies) {
  if (messageBodies.length > 10) {
    throw `messageBodies.length > 10 : ${messageBodies}`;
  }
 ...
 */
async function addEachLineToQueue(filename, queueUrl) {
